...
def check_for():
    try:
        ...
        os.system('cmd /c "pyinstaller --noconfirm --onedir --windowed --icon "D:/pharm logo.ico" --add-data "C://Users//Annoymous\AppData\Local//Programs//Python//Python310//Lib//site-packages//customtkinter;customtkinter//"  "C://dose//augmentin.py" --distpath "c://dose2//""')
